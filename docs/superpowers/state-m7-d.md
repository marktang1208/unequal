...
7. **🆕 P4 #3 deploy pipeline 修复** — ✅ **2026-06-24 PASS** (4 commits `eaba082`/`6d877fd`/`8500309`/`1b8ccf1` + state `d0a524c`, 626/626 tests, 真接 6 步 PASS + admin login 200 JWT 205 chars。真接发现 + 修 5 个 SDK bug: Client 签名 `{credential,region}` / `BasicCredential` 类 / `GetFunction` 方法 / Namespace=envId / push 完整 20 vars. 详见 spec `2026-06-24-p4-deploy-scf-sdk-design.md` + memory `project_p4_3_deploy_scf_sdk.md`)
